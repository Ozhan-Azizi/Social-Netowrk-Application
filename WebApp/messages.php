...
<html>
    ...
    if(isset($_POST['text']))
    {
        $replyMessage = $_POST['text'];
        $sendingTo = $_POST['sendingTo'];
        $m_id = $_POST['replied'];
        
        if($replyMessage != "")
        {
            queryMysql("INSERT INTO message VALUES ('0','$user','$sendingTo','$replyMessage', 'no')");
            queryMysql("UPDATE message SET readMessage='yes' where id='$m_id'");
        }
    }
    
    if(isset($_GET['checkBox']))
    {
        $whatToDisplay = $_GET['checkBox'];
    }
            ...
            <div class='inputEverything'>
                <div class='menu3'>
                    <form method='get' action='messages.php'>
                        <input id="checkbox" name="checkBox" type="checkbox" value="1" />All Messages
                        <br> 
                        <input id="checkbox" name="checkBox" type="checkbox" value="0" />Messages Not Replied
